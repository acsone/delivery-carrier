...
class TestZoneFindNextSchedule(DeliveryZoneScheduleCommon):
    ...
    def test_earliest_slot_is_returned(self):
        ...
        schedule, departure = self.delivery_zone_a.find_next_schedule()
    ...
    def test_single_schedule_zone_returns_it(self):
        ...
        schedule, departure = self.delivery_zone_b.find_next_schedule()
    ...
    def test_empty_zone_returns_false(self):
        ...
        schedule, departure = self.zone_empty.find_next_schedule()
    ...
    def test_later_from_date_skips_imminent_slot(self):
        ...
        schedule, departure = self.delivery_zone_a.find_next_schedule(from_date=later)
    ...
    def test_timezone_shifts_opening_hours(self):
        ...
        """
        schedule, departure = self.delivery_zone_a.find_next_schedule(tz="Europe/Paris")
        self.assertEqual(schedule, self.schedule_14h)
    ...
    def test_dst_transition_resolved_correctly(self):
        ...
        schedule, departure = zone.find_next_schedule(tz="Europe/Paris")
    ...
    def test_closed_day_jumps_to_next_open_day(self):
        ...
        schedule, departure = zone.find_next_schedule()
