...
class DeliverySchedule(models.Model):
    ...
    def get_next_schedule(self, from_date=None, tz="UTC", horizon=None):
    ...
    def _scheduled_departures(self, from_date=None, tz="UTC", horizon=None):
        ...
        for day_offset in range(horizon):
            ...
            for schedule in self:
                ...
                if not schedule[weekday_field]:
                    continue
                # Localize the full departure datetime so DST transitions are
                # resolved at the actual departure time, not at midnight.
